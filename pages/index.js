      ...
      <div option={5} className="bg-black min-h-screen h-full p-8 sm:p-16">
        <div>
          <div className='text-center my-4'>
            ...
            <p className='py-2 font-light text-lg'>Stay updated with FIFA World Cup USA, Mexico &amp; Canada 2026</p>
          ...
          <div className='my-8 max-w-[650px] mx-auto'>
            ...
            <div className='py-4'>
              ...
              {sliceNextMatch !== 3 && <div className='py-3 w-full flex justify-center'>
                ...
                <p className='text-gray-400 opacity-75'>No upcoming matches scheduled.</p>
              )}
            </div>
          </div>
          <div className='my-8 max-w-[650px] mx-auto'>
